...
// #pragma omp parallel for
    ...
    results_file << Lpergrid_densities[0] << "\t" << std::setprecision(5) << std::scientific << L1_errors[0] 
    ...
    for (size_t i = 1; i < grid_densities.size(); ++i) {
        ...
        results_file << Lpergrid_densities[i] << "\t" << std::setprecision(5) << std::scientific << L1_errors[i] 
    ...
    std::cout << "【without_time】: " << std::endl;
